...
- **SEC-RANDOM-2** — All random calls must route through one seam, except the
  context blinding of SEC-RANDOM-3. Only regress builds can override the seam,
  to give tests a fixed random source (see D-12).
